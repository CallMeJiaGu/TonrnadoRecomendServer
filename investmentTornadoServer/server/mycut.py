...
if __name__ == '__main__':
    ...
    print ' '.join(jieba.cut(
        u'利用生物制造及生物三维技术中3D生物打印设备通常无法实现多喷头切换的问题。设备包括：喷头架和抓取等必要装置，最后通过三维打印工艺将矫形器数字三维模型打印成形。希望该3D生物打印设备能广泛应用于人体器官打印等前沿领域'))
    print ' '.join(mycuttor.fltcut(
        u'利用生物制造及生物三维技术中3D生物打印设备通常无法实现多喷头切换的问题。设备包括：喷头架和抓取等必要装置，最后通过三维打印工艺将矫形器数字三维模型打印成形。希望该3D生物打印设备能广泛应用于人体器官打印等前沿领域'))
